                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                                ...
                                stops: [0,1],
                                colors: <Color>[filter == filterList[index]?ColorClass.colorAccent:Colors.white, filter == filterList[index]?ColorClass.colorAccent:Colors.white,]),
                          ),
                          child: Row(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Text(
                                                "Connect Now",
                                                style:
                                                    TextStyle(color:ColorClass.colorAccent),
                                              ),
                                            )
                                          ],
                                        )
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) => Card(
                            ...
                            child: Container(
                                width: 300,
                                child: Image.network(
                                  "$baseUrl/assets/images/website_banner/" +
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          Container(
                            margin: EdgeInsets.fromLTRB(10, 10, 00, 00),
                            child: Text(
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => MyWebView(
                          "https://matrimonial.productsalphawizz.com/api/privacyPolicyPage/en",
                          "Privacy Policy")));
            },
          ),
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => MyWebView(
                          "https://matrimonial.productsalphawizz.com/api/termsConditionPage/en",
                          "Term And Conditions")));
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => MyWebView(
                          "https://matrimonial.productsalphawizz.com/api/faqPage/en",
                          "FAQs")));
            },
          ),
          ListTile(
